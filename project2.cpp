...
// It parses each statement and then evaluates it. It also initializes the symbol table before parsing the input
// file.
...
int main() {
	...
	while (true) {
        ...
        catch(variableinitializationexception& e) { //catch initialization errors
